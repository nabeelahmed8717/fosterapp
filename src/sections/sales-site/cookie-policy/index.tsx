export const listItems = [
  {
    id: 1,
    title: "Introduction",
    link: "/cookie-policy#introduction",
  },
  {
    id: 2,
    title: "About Cookies",
    link: "/cookie-policy#about-cookies",
  },
  {
    id: 3,
    title: "Cookies Type",
    link: "/cookie-policy#cookies-type",
  },
];
...
export const cookiesTypes = [
  ...
  },
  {
    ...
    description: `Third party cookies from social media sites (such as Facebook, Twitter, etc) let us track social network users when they visit or use the Website and Services, or share content, by using a tagging mechanism provided by those social networks.
...

  {
    ...
    description: `We reserve the right to modify this Policy or its terms relating to the Website and Services at any time, effective upon posting of an updated version of this Policy on the Website. When we do, we will revise the updated date at the bottom of this page. Continued use of the Website and Services after any such changes shall constitute your consent to such changes.`,
  },
  {
    id: 6,
    title: "Acceptance of this policy",
    description: `You acknowledge that you have read this Policy and agree to all its terms and conditions. By accessing and using the Website and Services you agree to be bound by this Policy. If you do not agree to abide by the terms of this Policy, you are not authorized to access or use the Website and Services.`,
  },
];
